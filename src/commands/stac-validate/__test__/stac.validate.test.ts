...
void describe('stacValidate', function () {
  void it('listLocation', async function () {
  ...
  void it('listLocationAwsList', async function () {
    assert.deepEqual(
