...
describe('stacCatalog', () => {
  ...
  it('listLocation', async () => {
    await fs.write(fsa.toUrl('m://base/directory1/collection.json'), JSON.stringify({ title: 'CollectionA' }));
    await fs.write(fsa.toUrl('m://base/directory2/collection.json'), JSON.stringify({ title: 'CollectionB' }));
